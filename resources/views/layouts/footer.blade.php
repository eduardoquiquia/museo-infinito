      ...
      <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
              ...
              <ul class="space-y-2 text-sm">
                  <li><a href="#" class="text-gray-400 hover:text-yellow-500">Inicio</a></li>
                  <li><a href="#" class="text-gray-400 hover:text-yellow-500">Exhibiciones</a></li>
                  <li><a href="#" class="text-gray-400 hover:text-yellow-500">Restaurante</a></li>
                  <li><a href="#" class="text-gray-400 hover:text-yellow-500">Eventos</a></li>
                  <li><a href="#" class="text-gray-400 hover:text-yellow-500">Contacto</a></li>
              </ul>
          </div>
